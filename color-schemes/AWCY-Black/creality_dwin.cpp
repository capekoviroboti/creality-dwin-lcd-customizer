      ...
      GRID_LOOP(x, y) {
        ...
        if (viewer_print_value) { 
          ...
          if (isnan(mesh_z_values[x][y])) {  // undefined
            DWIN_Draw_String(false, false, font6x12, Color_White, Color_Bg_Black, start_x_px + cell_width_px / 2 - 5, start_y_px + offset_y, F("X"));
          }
          else {                          // has value
            ...
            if (!(GRID_MAX_POINTS_X < 10))
              DWIN_Draw_String(false, false, font6x12, Color_White, Color_Bg_Black, start_x_px-2 + offset_x, start_y_px + offset_y /*+ square / 2 - 6*/, F("."));
            DWIN_Draw_String(false, false, font6x12, Color_White, Color_Bg_Black, start_x_px+1 + offset_x, start_y_px + offset_y /*+ square / 2 - 6*/, buf);
          }
        }
      }
    }
...
void CrealityDWINClass::Clear_Screen(uint8_t e/*=3*/) {
  if (e==1||e==3||e==4) DWIN_Draw_Rectangle(1, GetColor(eeprom_settings.menu_top_bg, Color_Bg_Black, false), 0, 0, DWIN_WIDTH, TITLE_HEIGHT); // Clear Title Bar
...
void CrealityDWINClass::Draw_Title(const char * title) {
  DWIN_Draw_String(false, false, DWIN_FONT_HEAD, GetColor(eeprom_settings.menu_top_txt, Color_White, false), Color_Bg_Black, (DWIN_WIDTH - strlen(title) * STAT_CHR_W) / 2, 5, title);
}
...
void CrealityDWINClass::Main_Menu_Icons() {
  if (selection == 0) {
    ...
    DWIN_Draw_String(false, false, DWIN_FONT_MENU, Color_White, Color_Bg_Black, 52, 200, F("Print"));
  }
  else {
  ...
  if (selection == 1) {
    ...
    DWIN_Draw_String(false, false, DWIN_FONT_MENU, Color_White, Color_Bg_Black, 170, 200, F("Prepare"));
  }
  else {
  ...
  if (selection == 2) {
    ...
    DWIN_Draw_String(false, false, DWIN_FONT_MENU, Color_White, Color_Bg_Black, 43, 317, F("Control"));
  }
  else {
    ...
    if (selection == 3) {
      ...
      DWIN_Draw_String(false, false, DWIN_FONT_MENU, Color_White, Color_Bg_Black, 179, 317, F("Level"));
    }
    else {
    ...
    if (selection == 3) {
      ...
      DWIN_Draw_Rectangle(0, GetColor(eeprom_settings.highlight_box, Color_White), 145, 246, 254, 345);
      DWIN_Draw_String(false, false, DWIN_FONT_MENU, Color_White, Color_Bg_Black, 181, 317, F("Info"));
    }
    else {
...
void CrealityDWINClass::Print_Screen_Icons() {
  if (selection == 0) {
    ...
    DWIN_Draw_String(false, false, DWIN_FONT_MENU, Color_White, Color_Bg_Black, 30, 322, F("Tune"));
  }
  else {
  ...
  if (selection == 2) {
    ...
    DWIN_Draw_String(false, false, DWIN_FONT_MENU, Color_White, Color_Bg_Black, 205, 322, F("Stop"));
  }
  else {
  ...
  if (paused) {
    if (selection == 1) {
      ...
      DWIN_Draw_String(false, false, DWIN_FONT_MENU, Color_White, Color_Bg_Black, 114, 322, F("Print"));
    }
    else {
    ...
    if (selection == 1) {
      ...
      DWIN_Draw_Rectangle(0, GetColor(eeprom_settings.highlight_box, Color_White), 96, 252, 175, 351);
      DWIN_Draw_String(false, false, DWIN_FONT_MENU, Color_White, Color_Bg_Black, 114, 322, F("Pause"));
    }
    else {
